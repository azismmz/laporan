                                        ...
                                        <tbody>
                                            @foreach ($hargabbmjbu as $hargabbmjbu)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6>Biaya Perolehan : {{ $hargabbmjbu->biaya_perolehan }}</h6>
                                                        <h6>Biaya Distribusi : {{ $hargabbmjbu->biaya_distribusi }}</h6>
                                                        <h6>Biaya Penyimpanan : {{ $hargabbmjbu->biaya_penyimpanan }}</h6>
                                                        <h6>Margin : {{ $hargabbmjbu->margin }}</h6>
                                                        <h6>PPN : {{ $hargabbmjbu->ppn }}</h6>
                                                        <h6>PBBKP : {{ $hargabbmjbu->pbbkp }}</h6>
                                                    </td>
