...
Route::middleware(['auth', 'checkRole'])->group(function () {
	...
	Route::controller(EvHasilOlahController::class)->group(function () {
		//		Route::post('/laporan/jual-hasil-olahan', 'indexJualHasilOlahan');
		//		Route::get('/laporan/jual-hasil-olahan', 'indexJualHasilOlahan');
		//		Route::put('/laporan/jual-hasil-olahan/update-revision/{id}', 'updateRevisionNotes');
